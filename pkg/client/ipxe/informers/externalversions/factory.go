...
import (
	...
	ipxe "github.com/mandelsoft/kipxe/pkg/client/ipxe/informers/externalversions/ipxe"
...
func (f *sharedInformerFactory) Ipxe() ipxe.Interface {
	return ipxe.New(f, f.namespace, f.tweakListOptions)
}
