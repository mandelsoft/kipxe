module github.com/mandelsoft/kipxe
...
require (
	...
	github.com/mandelsoft/spiff v1.3.0-beta-7.0.20201203090003-3687de5100f5
	github.com/mandelsoft/vfs v0.0.0-20201002134249-3c471f64a4d1 // indirect
